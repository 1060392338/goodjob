...
| REQ-GJ-LEAD-001 | ADR-0003/0008/0016/0017；L-0009 前置边界；L-0017/L-0018 证据 | TASK-GJ-0201 | Commit `59594d1` + `308cb67` + `db6c711`；分支 `codex/phase-3-lead-pipeline` | L-0017 管道；L-0018 CSV/XLSX/XLS、共享安全解析、映射/血缘、批次/部分失败、幂等/恢复、安全拒绝；`verify`；API 167；tenant 18；audit 0；最终 E2E 37/37 | In progress |
