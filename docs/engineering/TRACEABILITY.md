...
| REQ-GJ-LEAD-001 | ADR-0003/0008/0016；L-0009 前置边界；L-0017 证据 | TASK-GJ-0201 | Commit `59594d1` + `308cb67`；分支 `codex/phase-3-lead-pipeline` | L-0017 标准化/血缘/稳定键/检查点/恢复/Secret；`verify`；API 167；tenant 18；audit 0；E2E 37/37 | In progress |
