...
| REQ-GJ-LEAD-001 | ADR-0003/0008/0016/0017/0018/0019/0020；L-0009 前置边界；L-0017~L-0021 Evidence | TASK-GJ-0201 | Test-first `876ba19` + `603c664` + `3058c32` + `33e508c` + `789a0e4`；实现 `308cb67` + `db6c711` + `3b0c366` + `c361a26` + 阶段验收 `4e5b5b0`；分支 `codex/phase-3-lead-pipeline` | 统一 Pipeline、CSV/XLSX/XLS、Web 安全边界、API Provider 和阶段机器验收全部 PASS；duplicate writes 0；credential leaks 0；真实外呼 0；`verify`；audit 0；E2E 37/37；真实外部验证 Deferred | Done |
| REQ-GJ-AI-LEAD-001 | ADR-0002/0007/0010；阶段 3 验收交接 | TASK-GJ-0301 | L-0022 Ready，尚无实现 Commit | 金标评测、结构化输出、Prompt 注入、防污染、人工采纳/驳回/重跑；真实模型凭证需确认 | Ready |
