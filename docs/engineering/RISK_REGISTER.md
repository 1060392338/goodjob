...
| R-004 | 后端 `server.ts` 与前端 `prototype-api.ts` 文件过大，修改影响面和冲突风险高 | High | Mitigating | ADR-0005 规定渐进拆分；L-0004/L-0005 已迁移系统/认证/客户 9 个 API；L-0006 已迁移线索核心 9 个 API、来源血缘和领域服务，专项幂等/租户/生命周期测试与 167/37 门禁通过；后续继续线索外联/转化、AI、集成和前端模块 | 阶段 2 |
